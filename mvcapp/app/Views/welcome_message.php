...
<body>
	...
	<section id="section1" class="cd-section home-section">
		<div class="content-wrapper">
			<h1>Husnan<br /><b>05111940007002 - PBKK A</b></h1>
		</div>
	</section>
	...
	<section id="section2" class="cd-section">
		<div class="content-wrapper">
			...
			<p>A college student of Sepuluh Nopember Institute of Technology, Major at Informatics.
				...
				View my full skillset on <a href="https://www.linkedin.com/in/justhusnan/" target="_blank">LinkedIn</a>.</p>
		</div>
	</section>
		...
		<div class="content-wrapper">
			...
			<nav class="menu menu--viola menu-portofolio">
				<div class="menu__item">
					<a href="https://github.com/husnan622" class="menu__link" target="_blank">
	...
	<section id="section4" class="cd-section">
		<div class="content-wrapper">
			...
			<nav class="menu menu--iris">
				<ul class="menu__list">
					<li class="menu__item">
						<a href="https://www.instagram.com/justhusnan/" class="menu__link" target="_blank">Instagram</a>
					</li>
					<li class="menu__item">
						<a href="https://www.linkedin.com/in/justhusnan/" class="menu__link" target="_blank">LinkedIn</a>
					</li>
					<li class="menu__item">
						<a href="https://github.com/husnan622" class="menu__link" target="_blank">GitHub</a>
					</li>
					<li class="menu__item">
						<a href="mailto: husnan.alcazaba@gmail.com" class="menu__link" target="_blank">Mail</a>
					</li>
				</ul>
			</nav>
		</div>
